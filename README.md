...
To run all tests, including unit tests, with code style checking use `npm run test:all`.\
To run all tests, including unit tests, with code coverage checking use `npm run test:cc`.\
