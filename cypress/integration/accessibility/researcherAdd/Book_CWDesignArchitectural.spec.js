context('WCAG', () => {
    it('Researcher form', () => {
        ...
        cy.log('Book - Creative Work - Design/Architectural');
        ...
        cy.get('li[data-value="Creative Work - Design/Architectural"]').click();
        cy.get('h3').contains('Book information');
        cy.checkA11y('div#content-container', {
            reportName: 'Book - Creative Work - Design/Architectural',
            scopeName: 'Form',
