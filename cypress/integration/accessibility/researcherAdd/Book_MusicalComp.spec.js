context('WCAG', () => {
    it('Researcher form', () => {
        ...
        cy.log('Book - Creative Work - Musical Composition');
        ...
        cy.get('li[data-value="Creative Work - Musical Composition"]').click();
        cy.get('h3').contains('Book information');
        cy.checkA11y('div#content-container', {
            reportName: 'Book - Creative Work - Musical Composition',
            scopeName: 'Form',
