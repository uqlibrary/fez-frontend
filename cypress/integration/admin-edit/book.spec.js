        ...
        cy.get('@bibliographicTab')
            .within(() => {
                ...
                cy.get('#issn-list-editor-row-3')
                    ...
                    .parents('#issn-list-editor-row-3')
