...
context('Claim possible work', () => {
    ...
    it('can cancel a claim after filling the form', () => {
        ...
        cy.contains('[role="document"]', claimFormLocale.cancelWorkflowConfirmation.confirmationTitle)
            ...
            .click();
        cy.url().should('equal', `${baseUrl}/records/possible`);
    });
    ...
    it('can choose author, then submit the claim.', () => {
        ...
        cy.contains('h6', claimFormLocale.successWorkflowConfirmation.confirmationTitle).should('have.length', 1);
        cy.contains('button', claimFormLocale.successWorkflowConfirmation.cancelButtonLabel).click();
        cy.url().should('equal', `${baseUrl}/records/possible`);
    });
