context('Data Collection form', () => {
    ...
    it('Form behaves as expected', () => {
        ...
        cy.get('div.Alert').find('li')
            .should('have.length', 5);
        cy.get('div.Creators').get('button[aria-label="Remove all items"]')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        ...
        cy.get('div.Fundingbody').find('button#add-items')
            .click();
        cy.get('input#funding-body-input').type('Funding body 2', { delay: 1 });
        cy.get('div.Fundingbody').find('button#add-items')
            .click();
        cy.get('div.Fundingbody').find('button[title="Move funding body up the order"]')
            .click();
        cy.get('div.Fundingbody').find('button#delete-0')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        cy.get('div.Fundingbody').find('button[title="Remove all funding bodies"]')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        ...
        cy.get('div.GrantIDs').find('button#add-items')
            .click();
        cy.get('input#grant-id-input').type('Grant ID 2', { delay: 1 });
        cy.get('div.GrantIDs').find('button#add-items')
            .click();
        cy.get('div.GrantIDs').find('button[title="Move grant ID up the order"]')
            .click();
        cy.get('div.GrantIDs').find('button#delete-0')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        cy.get('div.GrantIDs').find('button[title="Remove all grant IDs"]')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        ...
        cy.get('div.Typeofdata').find('button#add-items')
            .click();
        cy.get('input#type-of-data-input').type('Type of data 2', { delay: 1 });
        cy.get('div.Typeofdata').find('button#add-items')
            .click();
        cy.get('div.Typeofdata').find('button[title="Move type of data up the order"]')
            .click();
        cy.get('div.Typeofdata').find('button#delete-0')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        cy.get('div.Typeofdata').find('button[title="Remove all type of data"]')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        ...
        cy.get('div.Softwarerequired').find('button#add-items')
            .click();
        cy.get('input#software-required-input').type('Software required 2', { delay: 1 });
        cy.get('div.Softwarerequired').find('button#add-items')
            .click();
        cy.get('div.Softwarerequired').find('button[title="Move software required up the order"]')
            .click();
        cy.get('div.Softwarerequired').find('button#delete-0')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        cy.get('div.Softwarerequired').find('button[title="Remove all software required"]')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        ...
        cy.get('div.Keywords').find('button#add-items')
            .click();
        cy.get('input#keywords-input').type('Keywords 2', { delay: 1 });
        cy.get('div.Keywords').find('button#add-items')
            .click();
        cy.get('div.Keywords').find('button[title="Move keyword up the order"]')
            .click();
        cy.get('div.Keywords').find('button#delete-0')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        cy.get('div.Keywords').find('button[title="Remove all keywords"]')
            .click();
        cy.get('button')
            .contains('Yes')
            .click();
        ...
        cy.get('input#rek_start_date').clear()
            .type('01/01/1980', { delay: 1 });
        cy.get('input#rek_start_date').blur();
        cy.get('input#rek_end_date').clear()
            .type('01/01/1979', { delay: 1 });
        cy.get('input#rek_end_date').blur();
        cy.get('div[aria-describedby="rek_start_date-helper-text"]').find('p')
        ...
        cy.get('div[class="undefined Relateddatasets/work"]').get('div.ListRow-NoLabel')
            .first()
            .get('p')
        ...
        cy.get('div[class="undefined Relateddatasets/work"]').get('button[title="Move item up the order"]')
            .click();
        cy.get('div[class="undefined Relateddatasets/work"]').get('div.ListRow-NoLabel')
            .last()
            .get('p')
