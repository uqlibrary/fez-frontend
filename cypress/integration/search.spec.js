context('Search', () => {
    ...
    it('Doing a basic search to advanced search', () => {
        ...
        cy.get('#showAdvancedSearchButton')
            .should('be.visible');
        ...
        cy.get('div[aria-label="Click to select a field to search from the list - Select a field currently selected"]')
            .get('p')
        ...
        cy.get('button#advancedSearchButton')
            .should('not.to.have.attr', 'disabled');
        ...
        cy.get('[data-value="rek_ismemberof"]')
            .click();
        cy.get('button#advancedSearchButton')
            .should('to.have.attr', 'disabled');
        cy.get('div')
            ...
            .click();
        cy.get('[data-value="UQ:131735"]')
            .click();
        cy.get('[data-value="UQ:131375"]')
            .click();
        cy.get('[data-value="UQ:292807"]')
            .click();
        cy.get('div[id="menu-"]')
            .click(10, 10);
        cy.get('button#advancedSearchButton')
