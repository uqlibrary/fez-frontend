context('Search', () => {
    ...
    it('Doing a basic search to advanced search', () => {
        ...
        cy.get('.StandardCard').should('contain', 'Displaying works 1 to 6 of 6 total records.');
        ...
        cy.get('input[name="searchField0"]').should('have.value', 'cats and dogs');
        ...
        cy.get('div[id="menu-"]').click(10, 10);
        cy.get('button#advancedSearchButton').should('not.to.have.attr', 'disabled');
    });
});
