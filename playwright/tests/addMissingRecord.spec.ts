...
test.describe('Reorder and edit Contributor(s)', () => {
    ...
    test('contributors can be reordered and edited', async ({ page }) => {
        ...
        // is selected.
        await expect(page.locator('[data-testid="rek-author-list-row-1"] [data-testid="PersonIcon"]')).toBeVisible();
        await expect(
        ...
        // is selected.
        await expect(page.locator('[data-testid="rek-author-list-row-0"] [data-testid="PersonIcon"]')).toBeVisible();
        await expect(
