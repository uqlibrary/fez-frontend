...
test.describe('As an admin,', () => {
    test('I can create a collection', async ({ page }) => {
        ...
        await page
            ...
            .click();
        await expect(page.locator('h3').getByText(/Collection details/)).toBeVisible();
        ...
        await expect(page.getByTestId('rek-keywords-list').locator('p', { hasText: /testing/ })).toBeVisible();
        await page
            .locator('button')
