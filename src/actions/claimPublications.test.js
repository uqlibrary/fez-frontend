...
describe('Claim publication actions tests ', () => {
    ...
    describe('claimPublication()', () => {
        ...
        it(
            'dispatched expected actions when claiming a publication by author ' +
                'who is assigned to publication already with some author linked',
            async() => {
                const testRequest = {
                    ...testClaimRequest,
                    publication: {
        ...
        it(
            'dispatched expected actions when claiming a publication by ' +
                'contributor who is assigned to publication already',
            async() => {
                const testRequest = {
                    ...testClaimRequest,
                    publication: {
