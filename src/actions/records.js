...
export function createNewRecord(data) {
    return dispatch => {
        ...
        const recordRequest = {
            ...
            ...transformers.getRecordAuthorsSearchKey(data.authors || [data.currentAuthor[0]] || null),
            ...transformers.getRecordAuthorsIdSearchKey(data.authors || [data.currentAuthor[0]] || null),
