...
describe('Record action creators', () => {
    ...
    it('should dispatch RECORD_CREATE_SAVING and RECORD_CREATE_SUCCESS actions for create new record', () => {
        const data = {
            "currentAuthor": [
                {
        ...
        const expectedActions = [
            {type: actions.RECORD_CREATE_SAVING},
    ...
    it('should dispatch RECORD_CREATE_SAVING, ACCOUNT_ANONYMOUS and RECORD_CREATE_FAILED actions for create new record', () => {
        const data = {
            "currentAuthor": [
                {
                    "nameAsPublished": "Researcher, J",
    ...
    it('should dispatch RECORD_CREATE_SAVING and RECORD_CREATE_SUCCESS actions for patch record failed', () => {
        const data = {
            "currentAuthor": [
                {
                    "nameAsPublished": "Researcher, J",
    ...
    it('should dispatch RECORD_CREATE_RESET action', () => {
        store.dispatch(recordActions.clearNewRecord());
        expectStoreHasExpectedActions(store, [{type: actions.RECORD_CREATE_RESET}]);
    });
});