...
export const NTRO_COMMISSIONED_RESEARCH_REPORT_SUBTYPES = [
    NTRO_SUBTYPE_RREB_PUBLIC_SECTOR,
    NTRO_SUBTYPE_RREB_INDUSTRY,
    NTRO_SUBTYPE_RREB_NOT_FOR_PROFIT,
];

export const NTRO_RESEARCH_REPORT_SUBTYPES = [...NTRO_COMMISSIONED_RESEARCH_REPORT_SUBTYPES, NTRO_SUBTYPE_RREB_OTHER];
