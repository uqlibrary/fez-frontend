...
export const WOS_DOC_TYPES = [
    ...
    { value: '', text: 'Data Paper' },
    { value: '0', text: '0 - Database Review' },
    { value: 'D', text: 'D - Discussion' },
    { value: '', text: 'Early Access (Web of Science Core Collection only)' },
    ...
    { value: '', text: 'Item About an Individual' },
    { value: 'L', text: 'L - Letter' },
    { value: 'MC', text: 'MC - Meeting Abstract' },
    { value: '', text: 'Meeting Summary' },
