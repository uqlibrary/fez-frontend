        ...
        tabs: {
            ...
            tabContent: {
                rows: [
                    ...
                    {
                        heading: 'Cite Score',
                        fieldId: 'jnl-cite-score-asjc-code-cite-score',
                        data: [
                            {
                                path: ['jnl_cite_score_asjc_code_cite_score'],
                            },
                        ],
                    },
                    {
                    ...
                    {
                        heading: 'SNIP',
                        fieldId: 'jnl-cite-score-asjc-code-snip',
                        data: [
                            {
                                path: ['jnl_cite_score_asjc_code_snip'],
                            },
                        ],
                    },
                    {
                        heading: 'SJR',
                        fieldId: 'jnl-cite-score-asjc-code-sjr',
                        data: [
                            {
                                path: ['jnl_cite_score_asjc_code_sjr'],
                            },
                        ],
                    },
                    {
                        heading: 'Percent Cited',
                        fieldId: 'jnl-cite-score-asjc-code-percent-cited',
                        data: [
                            {
                                path: ['jnl_cite_score_asjc_code_percent_cited'],
                            },
                        ],
                    },
                ],
