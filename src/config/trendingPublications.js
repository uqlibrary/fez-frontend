    ...
    sources: {
        scopus: {
            metricDataPath: {
                ...
                past_count: 'fez_record_search_key_scopus_id.fez_scopus_citations.sc_3m',
        ...
        thomson: {
            metricDataPath: {
                ...
                past_count: 'fez_record_search_key_isi_loc.fez_thomson_citations.tc_3m',
        ...
        altmetric: {
            metricDataPath: {
                ...
                past_count: 'fez_record_search_key_doi.fez_altmetric.as_3m',
