...
export const isDateEqualOrGreaterThan = (date, anotherDate, format = 'YYYY-MM-DD') =>
    moment(moment(date).format(format)).isSameOrAfter(moment(anotherDate).format(format));
