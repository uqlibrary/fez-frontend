...
export const peopleRequired = (list, validationError) =>  !list || list.length === 0 || list.filter(item => (item.selected)).length === 0 ? validationError : undefined;
export const authorRequired = (authors) => peopleRequired(authors, validationErrors.authorRequired);
export const supervisorRequired = (supervisors) => peopleRequired(supervisors, validationErrors.supervisorRequired);
