...
describe('Search record results', () => {
    ...
    it('should render a single claimable item with no authors on the record (record should appear in publicationsList prop)', () => {
        ...
        const wrapper = setup({history: history, actions: actions, publicationsList: publicationsList});
        expect(toJson(wrapper)).toMatchSnapshot();
    });

    it('should render a single unclaimable item with no authors on the record (record should appear in publicationsListSubset prop)', () => {
        const navigateToClaimPublication = jest.fn();
        const setClaimPublication = jest.fn();
        const actions = {
            setClaimPublication: setClaimPublication
        ...
        const wrapper = setup({publicationsList: publicationsList});
        expect(toJson(wrapper)).toMatchSnapshot();
    });
