...
NtroSectionContainer.propTypes = {
...
export const mapStateToProps = (state, ownProps) => {
    ...
    return {
        ...
        formValues: formValues.get('ntroSection') || Immutable.Map({}),
    };
};

export default connect(mapStateToProps)(React.memo(NtroSectionContainer));
