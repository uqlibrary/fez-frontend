...
import { DEFAULT_DATE_FORMAT_WITH_TIME, SYSTEM_ALERT_ACTION, getFormattedServerDate } from '../config';
...
describe('SystemAlertsDrawer', () => {
    ...
    it('should render drawer for unassigned alert', () => {
        ...
        expect(getByTestId('system-alert-detail-date-created')).toHaveTextContent(
            getFormattedServerDate(testRowUnassigned.sat_created_date, DEFAULT_DATE_FORMAT_WITH_TIME),
        );
    ...
    it('should render drawer for assigned alert', () => {
        ...
        expect(getByTestId('system-alert-detail-date-created')).toHaveTextContent(
            getFormattedServerDate(testRowAssigned.sat_created_date, DEFAULT_DATE_FORMAT_WITH_TIME),
        );
        expect(
