...
export const MyIncompleteRecord = (componentProps) => (<Async load={import('modules/MyIncompleteRecords/containers/MyIncompleteRecord')} componentProps={componentProps} />);
