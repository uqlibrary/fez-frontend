...
import CommunityCollectionsPagingWithStyles from './CommunityCollectionsPaging';
...
function setup(testProps = {}) {
    return getElement(CommunityCollectionsPaging, getProps(testProps));
}

describe('CommunityCollectionsPaging renders ', () => {
    ...
    it('component with styles', () => {
        const wrapper = getElement(CommunityCollectionsPagingWithStyles, getProps());
        expect(toJson(wrapper)).toMatchSnapshot();
    });
...
describe('CommunityCollectionsPaging responsive rendering ', () => {
    const testProps = {
        pagingData: {
            total: 20,
            took: 10,
    ...
    const setup = (theme, testProps) => {
        return render(
            <MuiThemeProvider theme={theme}>
                <CommunityCollectionsPaging {...testProps} />
            </MuiThemeProvider>,
        );
    };
