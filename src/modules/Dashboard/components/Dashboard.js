                                                                    ...
                                                                    <div className="column">
                                                                        ...
                                                                        <div className="citationCounts">
                                                                            <div className="citationCount column" style={{margin: '0px', padding: '0px'}}>
                                                                                <a href={recordValue.citation_url} className="citationCountLink" target="_blank" title={txt.global.linkWillOpenInNewWindow.replace('[destination]', recordValue.title)}>
