...
describe('MyIncompleteRecord Container', () => {
    ...
    it('should load initial values for admin author and if search key is not there then it should get default', () => {
        ...
        delete recordToFix.fez_record_search_key_significance;
        delete recordToFix.fez_record_search_key_creator_contribution_statement;
        ...
        const testRecord = {
            ...
            fez_record_search_key_quality_indicator: [
                ...
                },
                {
                    ...
                    rek_quality_indicator_lookup:
                        'Association with recognised international entities, distinct from co-creation',
                },
            ],
            fez_record_search_key_significance: [
                {
