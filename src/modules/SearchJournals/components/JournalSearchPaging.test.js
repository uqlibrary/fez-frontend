import { PublicationsListPaging } from 'modules/SharedComponents/PublicationsList/components/PublicationsListPaging';
import PublicationsListPagingWithStyles from 'modules/SharedComponents/PublicationsList/components/PublicationsListPaging';
...
describe('JournalSearchPaging renders ', () => {
    ...
    it('component with non-empty paging data, pageChanged called', () => {
        ...
        const wrapper = setup({ pagingData: data, disabled: false, onPageChanged: testFunction, isShallow: false });
