...
describe('ContributorsEditor', () => {
    ...
    const testFunction = {
        get: reducer =>
            reducer === 'accountReducer'
                ...
                : {
                      recordToView: { rek: 'test' },
                  },
    };

    it('should map state to props as expected', () => {
        expect(mapStateToProps(testFunction)).toEqual({
            author: 'test',
            record: { rek: 'test' },
        });
        expect(
    ...
    describe('actions', () => {
        ...
        //     expect(mockActionsStore.getActions()).toHaveDispatchedActions(expectedActionsOrgs);
        // });
        // it('loadSuggestedOrganisationalUnitsList:
        // should map dispatch to props as expected when failing', async () => {
