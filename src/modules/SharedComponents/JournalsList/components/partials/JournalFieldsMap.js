...
import { types, status, useOAIndicator } from './hooks';
...
export const JournalFieldsMap = () => {
    const { getIndicator } = useOAIndicator();
    return [
        {
            key: 'jnl_title',
            label: 'Journal title',
        ...
        },
        {
            ...
            titleHelp: {
                ...
                text: (
                    <>
                        <p>
                            <b>Gold open access:</b> A freely accessible, final version of a publication is available
                            for everyone to read immediately after publication.
                        </p>
                        <p>
                            For other pathways:
                            <ul>
                        ...
                        <p>
                            Policies and agreements can change over time or be subject to limits. Click on the journal
        ...
        },
        {
            ...
            titleHelp: {
                ...
                text: (
                    <>
                        <p>
                            Indicates the highest quartile that the journal has ranked in <b>any subject category</b>{' '}
                            from Scopus <b>or</b> Web of Science.
                        </p>
        ...
        },
        {
            ...
            titleHelp: {
                ...
                text: (
                    <>
                        <p>
                            CiteScore percentile indicating where a journal is ranked within a subject category.
            ...
            titleHelp: {
                ...
                text: (
                    <>
                        ...
                        <p>
                            Higher is better e.g. 90 indicates that the journal is in the top 10% of its subject
                            category.
                        </p>
                    </>
                ),
        ...
        },
        {
            ...
            titleHelp: {
                ...
                text: (
                    <>
                        <p>
                            Scopus journal citation impact metric adjusted for field-specific citation practices.
                            Comparable across subject categories.
                        </p>
                        <p>
                            A journal with a SNIP of 1.0 has the median (not mean) number of citations for journals in
                            that field.
                        </p>
                    </>
                ),
                ...
                text: (
                    <>
                        <p>
                            ...
                            journal. Comparable across subject categories. Recommended for use in Life and Health
                            Science disciplines.
                        </p>
                        <p>Higher is better.</p>
                    </>
