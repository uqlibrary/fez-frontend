...
export default class JournalArticleForm extends Component {
    ...
    render() {
        ...
        const isAuthorSelected = this.props.formValues.get('authors') && this.props.formValues.get('authors').some((object) => { console.log(object); return object.selected === true;}) || false;
        ...
        return (
            <Grid container spacing={24}>
                ...
                </Grid>
                {
                    isAuthorSelected &&
                    <Grid item xs={12}>
                        <StandardCard title={'Research impact statement'}>
