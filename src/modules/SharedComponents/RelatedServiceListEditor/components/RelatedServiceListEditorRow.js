...
export const RelatedServiceListEditorRow = ({
    canEdit = false,
    index,
    relatedService,
    canMoveUp,
    ...
    locale = {
        ...
        editButtonId: 'edit-related-service',
    ...
    const { deleteRecordConfirmation, moveUpHint, moveDownHint, deleteHint, editHint, editButtonId } = locale;

    const selectedClass = relatedService.selected ? classes.selected : {};
    return (
        <Fragment>
                                    ...
                                    >
                                        <div style={{ display: 'inline' }}>
                                            <IconButton
                                                ...
                                                size="large"
                                                data-testid={`related-service-list-move-up=${index}`}
                                            >
                                    ...
                                    >
                                        <div style={{ display: 'inline' }}>
                                            <IconButton
                                                ...
                                                size="large"
                                                data-testid={`related-service-list-move-down=${index}`}
                                            >
...
RelatedServiceListEditorRow.propTypes = {
    canEdit: PropTypes.bool,
    index: PropTypes.number.isRequired,
    relatedService: PropTypes.object.isRequired,
...
export default React.memo(RelatedServiceListEditorRow);
