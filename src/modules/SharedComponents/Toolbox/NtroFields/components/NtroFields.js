...
export default class NtroFields extends React.PureComponent {
    ...
    render() {
        const {fields} = this.props.locale;
                ...
                }
                {
                    ...
                    <Grid item xs={12} sm={4}>
                        <Field
                            ...
                            fullWidth
                            disabled={this.props.submitting}
                            label={fields.extent.label}
                            placeholder={fields.extent.placeholder}
                            required
                ...
                }
                {
                    ...
                    <Grid item xs={12} sm={4}>
                        <Field
                            ...
                            fullWidth
                            disabled={this.props.submitting}
                            label={fields.physicalDescription.label}
                        />
                    </Grid>
                }
                {
                    ...
                    <Grid item xs={12} sm={4}>
                        <Field
                            ...
                            fullWidth
                            disabled={this.props.submitting}
                            label={fields.audienceSize.label}
                        />
                    </Grid>
                }
                {
                    ...
                    <Grid item xs={12} sm={4}>
                        <Field
                            ...
                            label={fields.peerReviewActivity.label}
                            required>
