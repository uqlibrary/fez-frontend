...
describe('Additional Information Component ', () => {
    ...
    it('getAbstract()', () => {
        const wrapper = setup({publication: {...records.journalArticle, rek_formatted_abstract: null}, isNtro: true});
        expect(toJson(wrapper.instance().getAbstract({...records.journalArticle, rek_formatted_abstract: null}))).toMatchSnapshot();
    });
    it('getAbstract()', () => {
        const wrapper = setup({publication: {...records.journalArticle, rek_formatted_abstract: null}, isNtro: false});
        expect(toJson(wrapper.instance().getAbstract({...records.journalArticle, rek_formatted_abstract: null, rek_description: null}))).toMatchSnapshot();
    });

    it('getAbstract()', () => {
        const wrapper = setup({publication: {...records.journalArticle, rek_formatted_abstract: null}, isNtro: false});
        expect(toJson(wrapper.instance().getAbstract({...records.journalArticle, rek_formatted_abstract: null, rek_description: 'Test'}))).toMatchSnapshot();
    });
    ...
    it('Full mount render', () => {
        const wrapper = getElement(AdditionalInformation, {publication: records.journalArticle, account: {canMasquerade: true}}, false);
        expect(toJson(wrapper)).toMatchSnapshot();
    });
});
