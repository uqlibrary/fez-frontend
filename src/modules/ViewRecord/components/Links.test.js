...
function setup(testProps, isShallow = true){
    const props = {
        ...testProps,
        publication: testProps.publication || null,
    };
    ...
    it('should render list of links with OA icons', () => {
        const linkProps = {
            ...
            "fez_record_search_key_link_description": [
                ...
                {
                    "rek_link_description_id": 3240201,
                    "rek_link_description_pid": "UQ:795347",
                    "rek_link_description_xsdmf_id": null,
                    "rek_link_description": null,
                    "rek_link_description_order": 3
                }
            ],
        };
...
describe('Links method tests ', () => {
    ...
    it('getDoiLink link creation function', () => {
        const recordDoi = '10.1093/hmg/ddw177';
        const recordOaStatus = '453693';
