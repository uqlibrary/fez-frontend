...
describe('searchRecords reducer', () => {
    ...
    it('should return deduplicated list of publications', () => {
        ...
        expect(result[0].sources.map(item => item.source)).toEqual(['espace', 'wos']);
        expect(result[1].sources.map(item => item.source)).toEqual(['espace', 'scopus']);
